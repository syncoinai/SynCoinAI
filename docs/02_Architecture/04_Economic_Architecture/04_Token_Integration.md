...
Toda transferencia de SYNC deberá procesarse mediante una transacción válida de la blockchain de SynCoinAI y deberá poseer un origen económico o protocolario identificable y trazable.
...
El sistema debe registrar toda transferencia de SYNC mediante una transacción válida de la blockchain de SynCoinAI, manteniendo la trazabilidad completa hacia su origen económico o protocolario.
...
# 17. Arquitectura de Alto Nivel
      ...
      PROVIDER      NETWORK      RESERVES
       WALLET         COST
          │
          ▼
   ECONOMIC STATE UPDATED

Note:
Reputation updates are generated by the Trust Architecture (Proof of Service + Verification) and are independent of
